...
class DemandsController extends AppController
{
    ...
    public function beforeRender(EventInterface $event)
    {
        ...
        if ($this->Authentication->getIdentity()->role !== 'member' && $this->Authentication->getIdentity()->role !== 'admin' && $this->Authentication->getIdentity()->role !== 'comptable' && $this->Authentication->getIdentity()->role !== 'manager') {
